...
J'ai fait en sorte de récupérer les users quand nécessaire, en essayant avec les nickname et les global_name
J'ai essayé de faire le flood avec un dictionnaire en variable global, mais me suis heurté à quelques problèmes concernant l'accès aux données et aux comparaison de date, je n'ai pas pu terminer cette étape